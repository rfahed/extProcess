...
def simulate():
    datafiles={"target.json":"kids_target_nobg.json", "instrument.json":"oneccd_test_instrument.json", "psf.fits":"psf_pixscale-0.18.fits", "stamps.fits":"stamps_gauss_pixscale-0.05.fits"}
